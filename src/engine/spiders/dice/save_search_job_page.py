...
from src.common.utils import get_page_number


class DiceSearchJobPageSaver(SearchJobPageSaver):
    def run(self, data_lake, driver):
        ...
        while True:
            ...
            try:
                ...
                print(
                    f"Time taken for page_index {page_index} to load the 19th job-details div: {wait_time:.2f} seconds")
                ...
                print(
                    f"Failed to load the 19th job-details div for page_index {page_index} within {preload_time} seconds.")
